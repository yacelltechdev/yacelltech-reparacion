            ...
            <div style={{ padding: '7px 12px', flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: repair.observacion ? '1fr 1fr' : '1fr', gap: '6px', marginBottom: '5px' }}>
                <div style={{ border: '1px solid #94A3B8', borderRadius: '8px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                  ...
                  <div style={{ padding: '4px 10px', fontSize: '13px', fontWeight: '600', lineHeight: '1.2', color: '#1E293B' }}>
                    {repair.sintoma}
                  </div>
                </div>
                ...
                {repair.observacion && (
                  <div style={{ border: '1px solid #94A3B8', borderRadius: '8px', overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div style={{ padding: '4px 10px', fontSize: '14px', lineHeight: '1.25', color: '#444', fontStyle: 'italic', fontWeight: '500' }}>
                      {repair.observacion}
                    </div>
                  </div>
                )}
