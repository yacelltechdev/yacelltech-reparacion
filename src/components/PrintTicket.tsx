        ...
        <div key={index} className="ticket" style={{ display: 'flex', flexDirection: 'column', padding: '4mm 8mm 6mm 8mm' }}>
          ...
          <div style={{ border: '2px solid #000', borderRadius: '12px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
            ...
            <div style={{ padding: '7px 12px', flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: repair.observacion ? '1fr 1fr' : '1fr', gap: '6px', marginBottom: '5px' }}>
              ...
              <div style={{ padding: '0 0 5px 0', fontSize: '13px', lineHeight: '1.4', color: '#1E293B', textAlign: 'justify' }}>
                <strong style={{ fontSize: '14px' }}>TÉRMINOS Y GARANTÍA:</strong> Después de 15 días no somos responsables de equipos dejados en el taller; luego de este tiempo el equipo será asumido para cubrir gastos incurridos en dicha reparación. Sin factura no hay reclamaciones ni se le entregará el equipo (pagar a la hora de recibir su equipo). No somos responsables de ninguna Sim Card o Memoria SD dejada en el dispositivo.
                <div style={{ marginTop: '4px', fontSize: '14px', fontWeight: 'bold', color: '#0F172A' }}>
                  No somos responsables de problemas ocultos distintos a los que se reportaron al momento de entregar el equipo a nuestro representante.
                </div>
              </div>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', padding: '0 20px 8px 20px', marginTop: 'auto' }}>
                <div style={{ width: '42%', textAlign: 'center' }}>
                  ...
                  <div style={{ borderTop: '1px solid #000', paddingTop: '5px', fontSize: '12px', color: '#1E293B' }}>
                    ...
                    <span style={{ fontSize: '10px', color: '#64748B' }}>Acepto los términos</span>
                  </div>
                </div>
                <div style={{ width: '42%', textAlign: 'center' }}>
                  <div style={{ height: '55px' }}></div>
