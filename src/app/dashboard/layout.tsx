...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { name: "Taller", icon: Wrench, path: "/dashboard/technician", roles: ["admin", "tech", "taller_jefe"] },
    { name: "Historial", icon: History, path: "/dashboard/history", roles: ["admin", "caja", "tech", "taller_jefe"] },
